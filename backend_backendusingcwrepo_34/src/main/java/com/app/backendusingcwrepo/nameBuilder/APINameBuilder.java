package com.app.backendusingcwrepo.nameBuilder;
...
public class APINameBuilder implements JPAEdmNameBuilder {
	...
	public String buildEntitySetName(final String entityTypeName) {
    	...
    	eSetName = "OperatingSupplies".equals(entityTypeName) ? "OperatingSupplies" : defaultNameBuilder.buildEntitySetName(entityTypeName);
